      ...
      <MaxWidthWrapper>
        <div className="max-w-3xl border-b border-slate-100 py-16 sm:py-20 lg:py-24">
          ...
          <div className="mt-4 space-y-6">
            ...
            >
              Built for commercial spaces that need structure.
            </motion.h1>
            <motion.p
            ...
            >
              Zyra delivers commercial interior execution with clear coordination,
              disciplined scope control and design-aware delivery for growing businesses
              in Saudi Arabia.
            </motion.p>
            <motion.div
