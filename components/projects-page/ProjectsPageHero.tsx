      ...
      <MaxWidthWrapper>
        <div className="max-w-3xl border-b border-slate-100 py-16 sm:py-20 lg:py-24">
          ...
          <div className="mt-4 space-y-6">
            ...
            >
              Spaces delivered with structure and precision.
            </motion.h1>
            <motion.p
            ...
            >
              Zyra approaches each commercial interior as a coordinated execution
              problem, shaped around brand, operations and the realities of business
              use.
            </motion.p>
            <motion.div
